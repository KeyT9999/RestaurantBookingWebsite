...
"""
Upload all images for 'The Grill' to Cloudinary and generate insert_the_grill_images.sql.
...
def get_cloudinary():
    ...
    if cloudinary_url:
        ...
        if not (cloud_name and api_key and api_secret):
            raise RuntimeError("Cloudinary credentials are missing. Set CLOUDINARY_URL or CLOUDINARY_CLOUD_NAME/API_KEY/API_SECRET")
...
def main():
    ...
    for idx, img_path in enumerate(images, start=1):
        public_id_base = f"restaurants/the_grill/{img_path.stem}"
    ...
    with open(out_sql, "w", encoding="utf-8") as f:
        f.write("-- Auto-generated by upload_the_grill.py\n")
        f.write("-- Insert gallery images for The Grill\n\n")
        for name, url in uploaded:
            # Default all uploaded images as 'gallery'
            f.write(
