-- =====================================================
-- SQL Script: XÓA NHÀ HÀNG "Sushi" VÀ TẤT CẢ DỮ LIỆU LIÊN QUAN
-- =====================================================
-- 
-- Script này sẽ xóa nhà hàng có tên chứa "Sushi" và tất cả dữ liệu liên quan:
...
BEGIN
    -- Tìm restaurant_id của nhà hàng có tên chứa "Sushi"
    ...
    IF v_restaurant_id IS NULL THEN
        RAISE NOTICE '❌ Không tìm thấy nhà hàng có tên chứa "Sushi"';
        RETURN;
    END IF;
...
SELECT 
    CASE 
        ...
        THEN '❌ Nhà hàng "Sushi" vẫn còn tồn tại trong database!'
        ELSE '✅ Nhà hàng "Sushi" đã được xóa thành công!'
